            ...
            switch (r.current()) {
                ...
                default:
                    if (r.matchesLetter()) {
                    	...
                    	String s = "wrong character "+ r.current() +" near opening tag";
                        t.error(this);
        ...
        void read(Tokeniser t, CharacterReader r) {
            ...
            switch (r.consume()) {
                ...
                case ' ':
                    ...
                    break;
                case '/':
                	if(Tokeniser.tagName.equals("field")){
                		System.out.print("'field' tag cannot be closed without defining attribute 'name'");
                		t.error(this,"'field' tag cannot be closed without defining attribute 'name'",true);
                		t.transition(Data);
                		break;
                	}
                	else{
                ...
                //Added by Imran Arif. 
                default:
                	if(Character.toString(t.getPreviousChar()).matches("[^\\w]")){
                		t.error(this,"Element Type ' " + Tokeniser.tagName + " ' must be followed by either attribute specifications, '>' or '/>'",true);
                		return;
                	}
            }
        }
    ...
    BeforeAttributeName {
        ...
        void read(Tokeniser t, CharacterReader r) {
            ...
            switch (c) {
                ...
                case '/':
/*                	if(t.consumeTagNameBackwards().equalsIgnoreCase("field")){
                		t.error(this,"'field' tag cannot be closed without defining attribute 'name'");
                		t.transition(Data);
                		break;
                	}
                	else{
