						             ...
						             <!-- <td onclick="createFromExistingField(this);">Create</td> -->
							             <td>
							                 ...
							                 <spring:bind path="command.fieldsList[${i.index}].fieldType.id">
							                 	<input style="display: none;" id='fTypeId' name='${status.expression}' value="${status.value }"/>
							                 </spring:bind>
							                 
							                 <spring:bind path="command.fieldsList[${i.index}].fieldType.name"> 
							                 	<input style="display: none;" id='fTypeName' name='${status.expression}' value="${status.value }"/>
							                 </spring:bind>
